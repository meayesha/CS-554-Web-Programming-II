...
//useEffect for pagination
  useEffect(() => {
    ...
    setParamValue(parseInt(props.match.params.pagenum));
    ...
    async function fetchData() {
      try {
        ...
        setShowsData(data);
        setLoading(false);
        setTotalPage(Math.ceil(data.length / 250));
    ...
    fetchData();
  }, [pageNumber, paramValue, props.match.params.pagenum]);
  ...
  if (loading) {
    ...
    return (
      <div>
        ...
        <br />
        <br />
      <Pagination previousClick={previousClick} nextClick={nextClick} pageNumber={pageNumber}/>
      <br />
        <br />
